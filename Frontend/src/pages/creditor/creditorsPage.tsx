...
//          <button className="tab-btn active">Nuevo Acreedor</button>
//          <button className="tab-btn">Buscar Acreedor</button>
//          <button className="tab-btn">Lista Negra</button>
//        </div>
//      </div>
//
...
function creditorsPage() {
  // 1. Definimos el estado para saber qué pestaña está activa.
  // Inicia por defecto en 'nuevo'
  const [activeTab, setActiveTab] = useState('nuevo');

  // 2. Función que decide qué vista renderizar según el estado actual
  const renderView = () => {
    switch (activeTab) {
      case 'nuevo':
